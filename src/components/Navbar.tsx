...
const UserMenu = ({ userDetails, signOut }: { userDetails: UserType; signOut: () => Promise<void> }) => {
  // Fix: Don't return null, provide a fallback if userDetails is missing
  // Ensure we always show the menu even if details are incomplete
  const userData = userDetails || { name: "User", email: "", role: "learner" as const };
