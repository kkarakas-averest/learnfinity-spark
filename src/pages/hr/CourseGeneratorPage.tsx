            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  Use commands like <code className="text-xs bg-muted px-1 py-0.5 rounded">/employees</code>, <code className="text-xs bg-muted px-1 py-0.5 rounded">/departments</code>, <code className="text-xs bg-muted px-1 py-0.5 rounded">/bulk</code> directly in the chat.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ChatErrorBoundary>
