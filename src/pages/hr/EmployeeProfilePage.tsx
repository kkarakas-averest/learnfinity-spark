...
// Add this validation helper function at the top of the file after interfaces
...
// Remove the ErrorBoundary class and instead add a SafeRender helper function
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Error Rendering Profile</h3>
            <p className="text-gray-600">Something went wrong when displaying this employee profile.</p>
                  ...
                  <div className="flex-shrink-0 h-20 w-20 rounded-full bg-gray-100 flex items-center justify-center">
                    {employee.profile_image_url ? (
                      <img 
                        ...
                        onError={(e) => {
                          console.warn('Failed to load profile image:', employee.profile_image_url);
